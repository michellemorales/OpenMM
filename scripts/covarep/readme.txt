...
================================
-run_COVAREP_feature_extraction.sh (shell script for temporarily setting environment 
 variables and executing the application)
   -to run the shell script, type
   
       ./run_COVAREP_feature_extraction.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v92, run the shell script as:
       ...
       ./run_COVAREP_feature_extraction.sh /mathworks/home/application/v92
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_COVAREP_feature_extraction.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MATLAB Runtime using the above  
    link, include it when building your component by clicking 
    the "Runtime downloaded from web" link in the Deployment Tool
-The Macintosh bundle directory structure COVAREP_feature_extraction.app 
   -this can be gathered up using the zip command 
    zip -r COVAREP_feature_extraction.zip COVAREP_feature_extraction.app
    or the tar command 
    tar -cvf COVAREP_feature_extraction.tar COVAREP_feature_extraction.app
-This readme file 
...
If it is defined, set it to the concatenation of these strings:
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_COVAREP_feature_extraction.sh 
